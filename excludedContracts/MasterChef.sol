...
/*  IronChef is a fork from Sushi's MiniChef v2 with slightly modification.
    ...
    We add 
    1. A TokenUtilityModule to boost/reduce user rewards depending on variables such as veSGT & NFTs
    2. Minor fix to exit function to not fail in case of secondary rewarder contract error
