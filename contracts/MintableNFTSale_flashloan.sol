...
contract MintableNFTSale_flashloan is MintableNFTSaleERC20 {
    ...
    function _flashmint(
        ...
        tokenIDToInfoMapping[supply] = Info({amt: amount, asset: asset});
    ...
    function free_mint(address asset, uint256 amount) public payable virtual whenMintNotPaused nonReentrant {
    ...
    function mint(
        ...
        uint256 amount,
        uint256 num
    ) public payable virtual override whenMintNotPaused nonReentrant {
        uint256 tokenCount = balanceOf(msg.sender);
