...
contract MintableNFTSaleERC20 is MintableNFTSale {
    ...
    constructor(
        ...
        MintableNFTSale(_name, _symbol, _paymentsSplitter, _price, _maxSupply, _maxPerMint, _premint, _freemint, admins)
    {}
    ...
    function free_mint() public payable virtual override whenMintNotPaused nonReentrant {
    ...
    function mint(
        ...
        uint256 amount,
        uint256 num
    ) public payable virtual whenMintNotPaused nonReentrant {
